...
class InventarisRequest extends FormRequest
{
    ...
    public function rules()
    {
        if($this->method() == 'POST'){
          ...
          $nama = 'required|string|min:5|max:50|unique:inventaris,i_nama,'.$this->get('i_id').',i_id';
          $kode = 'required|string|min:5|max:50|unique:inventaris,i_kode,'.$this->get('i_id').',i_id';
