...
class BagumumDataPeminjamanController extends Controller
{
    ...
    public function index(){
        ...
        ->get();
        $today = date("Y-m-d"); 
        return view('bagumum.dataPeminjaman', compact('data_peminjaman', 'data_peminjaman_sukses', 'today'));
    }
    ...
    public function lihat($id){
        ...
        ->get();
        return view('bagumum.lihatPeminjaman', compact('data_peminjaman'));
    }
    ...
    public function prosesKonfirmasi(Request $request){
        ...
        return redirect(url('/bagumum/peminjaman'));
    }
    ...
    public function cetakTahunan(Request $request){
        ...
        $pdf = PDF::loadview('bagumum.laporan_peminjaman_pdf',['data_peminjaman'=>$data_peminjaman, 'data_status'=>$request->post('tahunan')]);
    ...
    public function cetakBulanan(Request $request){
        ...
        $pdf = PDF::loadview('bagumum.laporan_peminjaman_pdf',['data_peminjaman'=>$data_peminjaman, 'data_status'=>$bulan." ".$myArray[1]]);
    	return $pdf->download('laporan-data-peminjaman.pdf');
    }
    public function cetakTanggal(Request $request){
        ...
        $pdf = PDF::loadview('bagumum.laporan_peminjaman_pdf',['data_peminjaman'=>$data_peminjaman, 'data_status'=>$myArray[1]." ".$bulan." ".$myArray[1]]);
    	return $pdf->download('laporan-data-peminjaman.pdf');
    }
