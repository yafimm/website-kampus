...
class DosenDataPeminjamanController extends Controller
{
    ...
    public function index(){
        ...
        ->get();
        return view('dosen.dataPeminjaman', compact('data_peminjaman'));
    }
    ...
    public function prosesHapus(Request $request){
        ...
        return redirect(url('/dosen/peminjaman'));
    }
    ...
    public function lihat($id){
        ...
        ->get();
        return view('dosen.lihatPeminjaman', compact('data_peminjaman'));
    }
    ...
    public function ubah($id){
        ...
        return view('dosen.ubahPeminjaman', compact('data_peminjaman','data_inventaris'));
    }
    public function pinjam(){
        $data_inventaris = DB::table('inventaris')->get();
        return view('dosen.pinjam', compact('data_inventaris'));
    }
