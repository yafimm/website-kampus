            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <div class="example-box-wrapper">
                            <form class="form-horizontal" action="{{ url('/dosen/request/prosesUbah') }}"
                                method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="idrequest" value="{{$data_request[0]->rb_id}}">
                                <input type="hidden" name="status" value="{{$data_request[0]->rb_status}}">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="idBarang" class="chosen-select">
                                            <optgroup label="Barang">
                                                ...
                                                <option @if ($data_request[0]->b_id == $barang->b_id)
                                                    {{'selected'}}
                                                    @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="jumlah" type="number" class="form-control" id=""
                                            placeholder="Jumlah" value="{{$data_request[0]->rb_jumlah}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-3">
