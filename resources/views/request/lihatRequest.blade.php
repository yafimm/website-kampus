...
<div class="container">
    ...
    <div id="page-title">
        <h2>Halaman Lihat Data Request</h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input disabled name="nama" type="text" class="form-control" id="nama"
                                    placeholder="Kolom Nama Pengguna" value="{{$data_request->user->name}}">
                            </div>
                        </div>
                                            ...
                                            <div class="center-vertical">
                                                <div class="center-content">
                                                    <h3 class="thumb-heading animated bounceIn">
                                                        {{$data_request->barang ? $data_request->barang->b_nama : '- Data Barang sudah dihapus -'}}
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="thumb-overlay bg-black"></div>
                                        <img src="{{ asset('assets/images-resource/barang/resize_'.($data_request->barang ? $data_request->barang->b_foto : '')) }}"
                                            alt="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input disabled name="jumlah" type="text" class="form-control" id="jumlah"
                                    placeholder="Kolom Jumlah" value="{{$data_request->rb_jumlah}}">
                            </div>
                        </div>
