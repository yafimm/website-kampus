                            ...
                            <td>
                                ...
                                @elseif($request->rb_status == 2)
                                    ...
                                    <button class="btn btn-success btn-md" data-toggle="modal"
                                      data-target="#modalSelesai" data-requestid="{{$request->rb_id}}" data-toggle="tooltip" data-placement="top" title="Selesai">
                                    <i class="glyph-icon icon-check"></i>
                                  </button>
                                  @endif

                                  @if(Auth::user()->hasRole('dosen') || Auth::user()->hasRole('mahasiswa'))
                                  <a href="{{ route('request.cetak.user', $request->rb_id) }}"
