                        ...
                        <table id="dt_barang" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($request->rb_status == 0)
                                        <a href="{{ url('/bagumum/request/lihat/'.$request->rb_id) }}"
                                            class="btn btn-info">
            ...
            <div class="modal fade" id="modalSetujuRequest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="setujuForm" id="setujuForm" action="{{ url('/bagumum/request/konfirmasi') }}"
            ...
            <div class="modal fade" id="modalTolakRequest" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="deleteForm" id="deleteForm" action="{{ url('/bagumum/request/konfirmasi') }}"
                            method="POST" class="form-horizontal">
                            {{ csrf_field() }}
            ...
            <div class="modal fade" id="modalReportTahunan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportTahunan" id="reportTahunan" action="{{ url('/bagumum/request/cetakTahunan') }}"
            ...
            <div class="modal fade" id="modalReportBulanan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportBulanan" id="reportBulanan" action="{{ url('/bagumum/request/cetakBulanan') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalReportTanggal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportHarian" id="reportHarian" action="{{ url('/bagumum/request/cetakHarian') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
                        ...
                        <table id="dt_peminjaman" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($peminjaman->p_status == 0)
                                        <a href="{{ url('/bagumum/peminjaman/lihat/'.$peminjaman->p_id) }}"
                                            class="btn btn-info">
                                            <i class="glyph-icon icon-circle-o"></i> Lihat
                                        </a>
            ...
            <div class="modal fade" id="modalSetujuPeminjaman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="setujuForm" id="setujuForm" action="{{ url('/bagumum/peminjaman/konfirmasi') }}"
                            method="POST" class="form-horizontal">
                            {{ csrf_field() }}
                            <input type="hidden" name="idsetuju" id="idsetuju">
                            <input type="hidden" name="jenis" id="jenis" value="2">
            ...
            <div class="modal fade" id="modalTolakPeminjaman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="deleteForm" id="deleteForm" action="{{ url('/bagumum/peminjaman/konfirmasi') }}"
                            method="POST" class="form-horizontal">
                            {{ csrf_field() }}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportTahunan" id="reportTahunan"
                            action="{{ url('/bagumum/peminjaman/cetakTahunan') }}" method="POST"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportBulanan" id="reportBulanan"
                            action="{{ url('/bagumum/peminjaman/cetakBulanan') }}" method="POST"
                            class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalReportTanggalPeminjaman" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportHarian" id="reportHarian" action="{{ url('/bagumum/peminjaman/cetakHarian') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
