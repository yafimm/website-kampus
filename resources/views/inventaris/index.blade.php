            ...
            <div class="example-box-wrapper">
                <table id="dt_inventaris" class="table table-striped table-bordered" cellspacing="0"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{ route('inventaris.lihat', $inventaris->i_id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Lihat Data">
                                  <i class="glyph-icon icon-eye"></i>
                              </a>
                              <a href="{{ route('inventaris.ubah', $inventaris->i_id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Ubah Data">
                                  <i class="glyph-icon icon-pencil"></i>
                              </a>
                                <button class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#modalHapus" data-inventarisid="{{$inventaris->i_id}}" data-toggle="tooltip" data-placement="top" title="Hapus Data">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="deleteForm" id="deleteForm" action="{{ route('inventaris.prosesHapus') }}"
            ...
            <div class="modal fade" id="modalReportTahunan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportTahunan" id="reportTahunan" action="{{ url('/admin/inventaris/cetakTahunan') }}"
            ...
            <div class="modal fade" id="modalReportBulanan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportBulanan" id="reportBulanan" action="{{ url('/admin/inventaris/cetakBulanan') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalReportTanggal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportHarian" id="reportHarian" action="{{ url('/admin/inventaris/cetakHarian') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
