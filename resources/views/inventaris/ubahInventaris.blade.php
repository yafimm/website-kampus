            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <div class="example-box-wrapper">
                            <form class="form-horizontal" action="{{ route('inventaris.prosesUbah', $data_inventaris[0]->i_id) }}"
                                method="POST" enctype="multipart/form-data">
                                <input type="hidden" name="id" id="id" value="{{$data_inventaris[0]->i_id}}">
                                @method('put')
                                {{ csrf_field() }}
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input name="nama" type="text" class="form-control" id=""
                                            placeholder="Kolom Nama Inventaris" value="{{$data_inventaris[0]->i_kode}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="nama" type="text" class="form-control" id=""
                                            placeholder="Kolom Nama Inventaris" value="{{$data_inventaris[0]->i_nama}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="unit" type="number" class="form-control" id=""
                                            placeholder="Kolom Unit Inventaris" value="{{$data_inventaris[0]->i_unit}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="harga" type="number" class="form-control" id=""
                                            placeholder="Kolom Harga Inventaris" value="{{$data_inventaris[0]->i_harga}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input required name="posisi" type="text" class="form-control" id=""
                                            placeholder="Kolom Posisi Inventaris" value="{{$data_inventaris[0]->i_posisi}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea placeholder="Kolom Keterangan Inventaris" class="form-control"
                                            name="keterangan" id="keterangan" cols="30" rows="10">{{$data_inventaris[0]->i_keterangan}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
