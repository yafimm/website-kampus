                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input disabled name="posisi" type="text" class="form-control" id=""
                                            ...
                                            value="{{$data_inventaris[0]->i_posisi}}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea disabled placeholder="Kolom Keterangan Inventaris" class="form-control"
                                            ...
                                            rows="10">{{$data_inventaris[0]->i_keterangan}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                                    ...
                                                    <div class="center-vertical">
                                                        <div class="center-content">
                                                            <h3 class="thumb-heading animated bounceIn">
                                                                {{$data_inventaris[0]->i_nama}}
                                                                <small>{{$data_inventaris[0]->created_at}}</small>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="thumb-overlay bg-black"></div>
                                                <img src="{{ asset('assets/images-resource/inventaris/resize_'.$data_inventaris[0]->i_foto) }}"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
