            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero my-2">
                        <a href="{{ route('pengadaan.create',['no_register' => $arr_pengadaan[0]->no_register, 'tanggal_pengadaan' => date('d-m-Y', strtotime($arr_pengadaan[0]->tanggal_pengadaan))]) }}" class="btn btn-primary">
                    ...
                    <h3 class="title-hero">
                      <div class="col-12 my-3">
                        ...
                        <h5>Total Keseluruhan : Rp. {{ number_format($arr_pengadaan->sum('biaya'), 2,',','.') }}</h5>
                      </div>
                    </h3>
