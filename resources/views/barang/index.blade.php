                  ...
                  <table id="dt_barang" class="table table-striped table-bordered" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                  <a href="{{ route('barang.lihat', $barang->b_id) }}" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Lihat Data">
                                      <i class="glyph-icon icon-eye"></i>
                                  </a>
                                  <a href="{{ route('barang.ubah', $barang->b_id) }}" class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="top" title="Ubah Data">
                                      <i class="glyph-icon icon-pencil"></i>
                                  </a>
                                  <button class="btn btn-danger btn-sm" data-toggle="modal"
                                      data-target="#modalHapus" data-barangid="{{$barang->b_id}}" data-toggle="tooltip" data-placement="top" title="Hapus Data">
                                      <i class="glyph-icon icon-trash"></i>
                                  </button>
                                  <button class="btn btn-primary btn-sm" data-toggle="modal"
                                      data-target="#modalRestock" data-barangid="{{$barang->b_id}}" data-toggle="tooltip" data-placement="top" title="Tambah Stok">
      ...
      <div class="modal fade" id="modalRestock" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                  ...
                  <form name="restockForm" id="restockForm" action="{{ route('barang.restock') }}"
                      method="POST" class="form-horizontal">
                      {{ csrf_field() }}
                      <input type="hidden" name="id" id="id">
                      <div class="modal-body">
