        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero">
                        <a href="{{ url('/admin/inventaris/tambah') }}" class="btn btn-primary">
                    ...
                    <div class="example-box-wrapper">
                        <table id="dt_inventaris" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/inventaris/lihat/'.$inventaris->i_id) }}" class="btn btn-info">
                                            <i class="glyph-icon icon-circle-o"></i> Lihat
                                        </a>
                                        <a href="{{ url('/admin/inventaris/ubah/'.$inventaris->i_id) }}"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form name="deleteForm" id="deleteForm" action="{{ url('/admin/inventaris/prosesHapus') }}"
