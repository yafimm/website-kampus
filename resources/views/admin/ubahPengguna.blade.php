            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <div class="example-box-wrapper">
                            <form class="form-horizontal" action="{{ url('/admin/pengguna/prosesUbah') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <a href="{{ url('/admin/pengguna') }}" class="btn btn-blue-alt"><i class="glyph-icon icon-arrow-left"></i> Kembali</a>
                                    </div>
                                </div>
