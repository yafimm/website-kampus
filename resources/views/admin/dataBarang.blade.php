        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero">
                        <a href="{{ url('/admin/barang/tambah') }}" class="btn btn-primary">
                        ...
                        <table id="dt_barang" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/barang/lihat/'.$barang->b_id) }}" class="btn btn-info">
                                            <i class="glyph-icon icon-circle-o"></i> Lihat
                                        </a>
                                        <a href="{{ url('/admin/barang/ubah/'.$barang->b_id) }}"
            ...
            <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="deleteForm" id="deleteForm" action="{{ url('/admin/barang/prosesHapus') }}"
            ...
            <div class="modal fade" id="modalReportTahunan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportTahunan" id="reportTahunan" action="{{ url('/admin/barang/cetakTahunan') }}"
            ...
            <div class="modal fade" id="modalReportBulanan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportBulanan" id="reportBulanan" action="{{ url('/admin/barang/cetakBulanan') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalReportTanggal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="reportHarian" id="reportHarian" action="{{ url('/admin/barang/cetakHarian') }}"
                            method="POST" class="form-horizontal bordered-row">
                            {{ csrf_field() }}
                            <div class="modal-body">
                                <div class="form-group">
            ...
            <div class="modal fade" id="modalRestock" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="restockForm" id="restockForm" action="{{ url('/admin/barang/prosesRestock') }}"
                            method="POST" class="form-horizontal">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" id="id">
                            <div class="modal-body">
