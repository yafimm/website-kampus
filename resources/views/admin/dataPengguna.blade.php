        ...
        <div class="container">
            ...
            <div class="panel">
                <div class="panel-body">
                    <h3 class="title-hero">
                        <a href="{{ url('/admin/pengguna/tambah/bagumum') }}" class="btn btn-primary">
                        ...
                        <table id="dt_pengguna" class="table table-striped table-bordered" cellspacing="0"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/admin/pengguna/lihat/'.$pengguna->id) }}" class="btn btn-info">
                                            <i class="glyph-icon icon-circle-o"></i> Lihat
                                        </a>
                                        <a href="{{ url('/admin/pengguna/ubah/'.$pengguna->id) }}" class="btn btn-warning">
                                            <i class="glyph-icon icon-pencil"></i> Ubah
                                        </a>
                                        <button class="btn btn-danger btn-md" data-toggle="modal"
                                            data-target="#modalHapus" data-userid="{{$pengguna->id}}">
                                            <i class="glyph-icon icon-remove"></i> Hapus
                                        </button>
                                        <button class="btn btn-info btn-md" data-toggle="modal"
                                            data-target="#modalPassword" data-userid="{{$pengguna->id}}">
                                            <i class="glyph-icon icon-circle-o"></i> Ubah Kata Sandi
                                        </button>
                                    </td>
                                </tr>
                                @endforeach
            ...
            <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="deleteForm" id="deleteForm" action="{{ url('/admin/pengguna/prosesHapus') }}"
            ...
            <div class="modal fade" id="modalPassword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form name="passwordForm" id="passwordForm" action="{{ url('/admin/pengguna/resetPassword') }}"
                            method="POST" class="form-horizontal">
                            {{ csrf_field() }}
