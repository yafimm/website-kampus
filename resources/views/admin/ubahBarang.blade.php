            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <div class="example-box-wrapper">
                            <form class="form-horizontal" action="{{ url('/admin/barang/prosesUbah') }}" method="POST"
                                enctype="multipart/form-data">
                                <input type="hidden" name="id" id="id" value="{{$data_barang[0]->b_id}}">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <a href="{{ url('/admin/barang') }}" class="btn btn-blue-alt"><i class="glyph-icon icon-arrow-left"></i> Kembali</a>
                                    </div>
                                </div>
