...
<div class="center-vertical">
    <div class="center-content row">
        ...
        <form action="{{ url('/register/regist') }}" id="login-validation" class="col-md-4 col-sm-5 col-xs-11 col-lg-3 center-margin"
            ...
            <h4 class="text-center pad25B font-black text-transform-upr font-size-15">Daftar aplikasi - Bagian Umum</h4>
