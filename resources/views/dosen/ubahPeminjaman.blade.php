            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="example-box-wrapper">
                        <div class="example-box-wrapper">
                            <form class="form-horizontal" action="{{ url('/dosen/peminjaman/prosesUbah') }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select id="inventaris" name="inventaris" class="chosen-select">
                                            <optiondata-invid="title" data-invnama="title" value="title">Silahkan Pilih
                                                </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <a href="{{ url('/dosen/peminjaman') }}" class="btn btn-blue-alt"><i
