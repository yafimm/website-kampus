    ...
    <div class="modal fade" id="modalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form name="deleteForm" id="deleteForm" action="{{ route('user.prosesHapus') }}" method="POST"
    ...
    <div class="modal fade" id="modalPassword" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form name="passwordForm" id="passwordForm" action="{{ route('user.resetPassword') }}" method="POST"
                    class="form-horizontal">
                    @method('post')
                    {{ csrf_field() }}
