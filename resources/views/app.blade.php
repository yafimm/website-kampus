        ...
        <div id="page-wrapper">
            <div id="page-header" class="bg-blue">
                ...
                <div id="header-logo" class="logo-bg">
                    <a href="/default" class="logo-content-big" title="Sistem Inventory Online">
                    </a>
                ...
                <div id="header-nav-left">
                    <div class="user-account-btn dropdown">
                        <a href="/default" title="My Account" class="user-profile clearfix" data-toggle="dropdown">
                            <img width="28" src="{{ asset('assets/images-resource/img-44.jpg') }}" alt="Profile image">
                        ...
                        <div class="dropdown-menu float-left">
                            <div class="box-sm">
                                <div class="login-box clearfix">
                                    <div class="user-img">
                                        <img src="{{ asset('assets/images-resource/img-44.jpg') }}" alt="">
                                    </div>
                                    <div class="user-info">
                                        ...
                                        <a href="/default" title="Edit profile">Edit profile</a>
                                        <a href="/default" title="View notifications">View notifications</a>
                                    </div>
                                </div>
                                <div class="pad5A button-pane button-pane-alt text-center">
                                    <a href="/logout" class="btn display-block font-normal btn-primary">
